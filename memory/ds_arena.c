...
inline void *ds_arena_alloc(_ds_arena_t_ *a, size_t size) {
  ...
  // if it's the first allocation or the memory used in this chunk plus the size we want is greater than the size of the chunk, we allocate a new bigger bloc of memory.
